...
if((++TotalNum) > MaxNum) break;
	...
	{ 
	str += "http://www.express360.net/cgi-bin/GInfo.dll?DispInfo&w=express360&nid=";
	str += o[i].niid;
	}
...
function DispWebPic(n)
{
		...
		{
			a_img[i]=new Image();
			a_img[i].src='http://www.express360.net/cgi-bin/GInfo.dll?WebPic&w=express360&order=' +i+ '&len=' + a_oWebPic[i].len;
