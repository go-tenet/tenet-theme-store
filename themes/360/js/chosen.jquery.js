...
(function() {
				...
				if (option.text !== "") {
					...
					this.parsed
							.push({
								...
								group_label : group_position != null ? this.parsed[group_position].label
										: null,
	...
	AbstractChosen = (function() {
		...
		AbstractChosen.prototype.choice_label = function(item) {
			if (this.include_group_label_in_selected
		...
		AbstractChosen.prototype.winnow_results = function() {
			...
			for (_i = 0, _len = _ref.length; _i < _len; _i++) {
				...
				if (this.include_option_in_results(option)) {
					...
					option.search_text = option.group ? option.label
							: option.html;
					if (!(option.group && !this.group_search)) {
						option.search_match = this.search_string_match(
								option.search_text, regex);
	...
	Chosen = (function(_super) {
		...
		Chosen.prototype.set_up_html = function() {
			...
			var width = this.container_width();
			if (width == "0px") {
				width = "152px";
			}
			container_props = {
